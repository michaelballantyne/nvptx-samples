...
static void __sti___12_noop_cpp1_ii_b81a68a1(void) __attribute__((__constructor__));
# 4 "noop.cu"
int main(void) {  return 0;
}
static void __sti___12_noop_cpp1_ii_b81a68a1(void) {   }

#include "noop.cudafe1.stub.c"
