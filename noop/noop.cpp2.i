...
# 134 "/usr/local/cuda/bin/../include/crt/device_runtime.h" 3
...
extern __attribute__((device)) void __assertfail(
  ...
  const void *function,
  size_t charsize);
# 173 "/usr/local/cuda/bin/../include/crt/device_runtime.h" 3
...
# 1 "noop.cu"
__attribute__((global)) extern void _Z6kernelv(void);
...
# 3 "noop.cu" 2
# 1 "noop.cu"
__attribute__((global)) void _Z6kernelv(void){
# 1 "noop.cu"
{
# 1 "noop.cu"
# 2 "noop.cu"
